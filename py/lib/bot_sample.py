...
#     senderID = message.chat.id
#     bot.send_message(senderID, 'State here bitch!')
    ...
    # bot.send_message(senderID, 'OS > ' + sysname + ' ' + release + ' ' + machine)
    # bot.send_message(senderID, 'Date@Time > ' + time.strftime('%a %d-%m-%y @ %H:%M'))
    # bot.send_message(senderID, 'Uptime > ' + str(uptime_hrs) + ' hr ' + str(uptime_mins) + ' min')
...
#     bot.send_message(senderID, 'dht22_1 @ ' + dht22_1_time + ' > t = ' + dht22_1_temp + '^C' + ' > h = ' + dht22_1_humid + '%')
#     time.sleep(1)
