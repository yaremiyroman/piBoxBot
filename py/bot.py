...
def climate(message):
    ...
    bot.send_message(senderID, '🌡 > ' + dht22_1_temp + '°' + ' 💧 > ' + dht22_1_humid + '%')
    ...
    bot.send_message(senderID, '🌡 > ' + dht11_1_temp + '°' + ' 💧 > ' + dht11_1_humid + '%')
    ...
    bot.send_message(senderID, '🌡 > ' + dht11_2_temp + '°' + ' 💧 > ' + dht11_2_humid + '%')
    ...
    bot.send_message(senderID, '🌡 > ' + dht11_3_temp + '°' + ' 💧 > ' + dht11_3_humid + '%')
    ...
    bot.send_message(senderID, '🌡 > ' + dht11_4_temp + '°' + ' 💧 > ' + dht11_4_humid + '%')
