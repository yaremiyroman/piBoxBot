...
CREATE TABLE dht11_2 (id INTEGER PRIMARY KEY AUTOINCREMENT, t NUMERIC, h NUMERIC, date_time TIMESTAMP DEFAULT CURRENT_TIMESTAMP NOT NULL);
CREATE TABLE dht11_3 (id INTEGER PRIMARY KEY AUTOINCREMENT, t NUMERIC, h NUMERIC, date_time TIMESTAMP DEFAULT CURRENT_TIMESTAMP NOT NULL);
CREATE TABLE dht11_4 (id INTEGER PRIMARY KEY AUTOINCREMENT, t NUMERIC, h NUMERIC, date_time TIMESTAMP DEFAULT CURRENT_TIMESTAMP NOT NULL);
...
CREATE TABLE mousture_1 (id INTEGER PRIMARY KEY AUTOINCREMENT, h NUMERIC, date_time TIMESTAMP DEFAULT CURRENT_TIMESTAMP NOT NULL);
CREATE TABLE mousture_2 (id INTEGER PRIMARY KEY AUTOINCREMENT, h NUMERIC, date_time TIMESTAMP DEFAULT CURRENT_TIMESTAMP NOT NULL);
CREATE TABLE mousture_3 (id INTEGER PRIMARY KEY AUTOINCREMENT, h NUMERIC, date_time TIMESTAMP DEFAULT CURRENT_TIMESTAMP NOT NULL);
CREATE TABLE mousture_4 (id INTEGER PRIMARY KEY AUTOINCREMENT, h NUMERIC, date_time TIMESTAMP DEFAULT CURRENT_TIMESTAMP NOT NULL);
CREATE TABLE steam_1 (id INTEGER PRIMARY KEY AUTOINCREMENT, h NUMERIC, date_time TIMESTAMP DEFAULT CURRENT_TIMESTAMP NOT NULL);
CREATE TABLE light_1 (id INTEGER PRIMARY KEY AUTOINCREMENT, l NUMERIC, date_time TIMESTAMP DEFAULT CURRENT_TIMESTAMP NOT NULL);
COMMIT;
