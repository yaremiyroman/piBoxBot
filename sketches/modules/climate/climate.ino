...
void loop() {
  ...
  // DS18B20
  // printSensor(DS18B20.label, getDS18B20Temp());
  ...
  // MOUSTURE_1
  printSensor(MOUSTURE_1.label, analogRead(MOUSTURE_1.pin));

  // MOUSTURE_2
  printSensor(MOUSTURE_2.label, analogRead(MOUSTURE_2.pin));

  // MOUSTURE_3
  printSensor(MOUSTURE_3.label, analogRead(MOUSTURE_3.pin));
